...
message=":hammer_and_wrench: Start ARM MacOS DSP update on \`$BRANCH_NAME\` ($ENV_LABEL)"
...
message=":white_check_mark: ARM MacOS DSP library successfully updated on \`$BRANCH_NAME\`"
